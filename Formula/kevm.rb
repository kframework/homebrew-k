class Kevm < Formula
  ...
  bottle do
    ...
    rebuild 1
    sha256 cellar: :any, mojave: "b71ff3c060e327c9a544b28a3c9b636bdb7126883491c01134753fd7842bc36b"
  end
  ...
  def install
    ...
    system "make", "K_RELEASE=/usr/local/lib/kframework", "RELEASE=1", "LIBFF_CC=clang", "LIBFF_CXX=clang++",
"BUILD_LOCAL=#{prefix}", "build-node"
    system "make", "K_RELEASE=/usr/local/lib/kframework", "RELEASE=1", "BUILD_LOCAL=#{prefix}",
